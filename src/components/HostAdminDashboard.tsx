      ...
      <header className="sticky top-0 z-50 bg-[#141813]/95 backdrop-blur-md border-b border-[#C4A482]/20 px-6 py-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#C4A482]/20 text-[#C4A482] border border-[#C4A482]/30 font-bold">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onExit}
              className="flex items-center gap-2 px-4 py-2 rounded-sm border border-stone-700 bg-stone-900/60 hover:bg-[#C4A482] hover:text-black hover:border-[#C4A482] text-xs font-mono tracking-wider transition-all duration-200 cursor-pointer"
            >
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <div className="p-5 rounded-sm bg-[#161B14] border border-stone-800 relative overflow-hidden">
            ...
            <div className="text-[11px] font-mono text-stone-400 mt-1">{applications.filter(a => a.status === 'pending').length} awaiting review</div>
          </div>
          ...
          <div className="p-5 rounded-sm bg-[#161B14] border border-stone-800 relative overflow-hidden">
            ...
            <div className="text-[11px] font-mono text-stone-400 mt-1">Ubud · Kyoto · Nosara</div>
          </div>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                ...
                {['All', 'pending', 'reviewed', 'accepted'].map((s) => (
                  <button
                    ...
                    className={`px-2.5 py-1 rounded text-[11px] border cursor-pointer uppercase ${
                      filterStatus === s
                ...
                {currentApp ? (
                  <div className="space-y-6 font-mono text-xs">
                    <div className="flex items-start justify-between border-b border-stone-800 pb-4">
                      <div>
                        <span className="text-[10px] text-[#C4A482] uppercase tracking-wider font-bold">
                    ...
                    <div className="grid grid-cols-2 gap-4 p-4 rounded bg-black/50 border border-stone-800/80">
                      <div>
                        <span className="text-[10px] text-stone-500 uppercase block mb-0.5">Program Selected</span>
                        <strong className="text-white text-xs">{currentApp.retreatTitle}</strong>
                      </div>
                      <div>
                        <span className="text-[10px] text-stone-500 uppercase block mb-0.5">Accommodation Tier</span>
                        <strong className="text-[#C4A482] text-xs">{currentApp.tierName}</strong>
                      </div>
                    </div>

                    <div>
                      <span className="text-[11px] text-stone-400 uppercase tracking-wider block mb-2 font-bold">
                    ...
                    {currentApp.dietaryRestrictions && (
                      <div>
                        <span className="text-[11px] text-stone-400 uppercase tracking-wider block mb-1 font-bold">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-stone-800">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-sm bg-blue-950/40 hover:bg-blue-900/60 border border-blue-800/50 text-blue-300 font-bold uppercase text-[10px] cursor-pointer"
                        >
                          Mark Reviewed
                        </button>
                        <button
                          ...
                          className="px-3 py-1.5 rounded-sm bg-emerald-950/40 hover:bg-emerald-900/60 border border-emerald-800/50 text-emerald-300 font-bold uppercase text-[10px] cursor-pointer"
                        >
                          Accept to Cohort
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 text-rose-400 hover:text-rose-300 text-[10px] uppercase font-bold cursor-pointer"
                      >
        ...
        {activeTab === 'occupancy' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono text-xs">
            <div className="p-6 rounded-sm bg-[#161B14] border border-stone-800">
              <span className="text-[10px] text-[#C4A482] uppercase tracking-wider font-bold">SANCTUARY 01</span>
              <h3 className="font-serif text-lg font-bold text-white mt-1 mb-2">Focus & Decompression (Ubud)</h3>
              <p className="text-stone-400 text-[11px] mb-4">October 12 – 18, 2026 · 7-Day Protocol</p>
              <div className="space-y-3">
                <div className="p-3 bg-black/50 rounded border border-stone-800 flex justify-between">
                  <div>
                    ...
                    <div className="text-[10px] text-stone-500">Private pool & outdoor shower</div>
                  </div>
                  <div className="text-right">
                    <div className="text-[#C4A482] font-bold">$4,800</div>
                    <div className="text-[10px] text-emerald-400">1 Spot Left</div>
                  </div>
                </div>
                <div className="p-3 bg-black/50 rounded border border-stone-800 flex justify-between">
                  <div>
                    <div className="text-white font-bold">Canopy Loft</div>
                    <div className="text-[10px] text-stone-500">Ergonomic deep workspace</div>
                  </div>
                  <div className="text-right">
                    <div className="text-[#C4A482] font-bold">$3,900</div>
                    <div className="text-[10px] text-stone-400">3 Spots Left</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-sm bg-[#161B14] border border-stone-800">
              <span className="text-[10px] text-[#C4A482] uppercase tracking-wider font-bold">SANCTUARY 02</span>
              <h3 className="font-serif text-lg font-bold text-white mt-1 mb-2">Wood Kiln Ceramics (Kyoto)</h3>
              <p className="text-stone-400 text-[11px] mb-4">November 04 – 11, 2026 · 8-Day Apprenticeship</p>
              <div className="space-y-3">
                <div className="p-3 bg-black/50 rounded border border-stone-800 flex justify-between">
                  <div>
                    <div className="text-white font-bold">Machiya Ryokan Room</div>
                    <div className="text-[10px] text-stone-500">Traditional tatami & cedar onsen</div>
                  </div>
                  <div className="text-right">
                    <div className="text-[#C4A482] font-bold">$5,400</div>
                    <div className="text-[10px] text-rose-400 font-bold">Sold Out</div>
                  </div>
                </div>
                <div className="p-3 bg-black/50 rounded border border-stone-800 flex justify-between">
                  <div>
                    <div className="text-white font-bold">Atelier Courtyard Loft</div>
                    <div className="text-[10px] text-stone-500">Adjacent to pottery wheels</div>
                  </div>
                  <div className="text-right">
                    <div className="text-[#C4A482] font-bold">$4,500</div>
                    <div className="text-[10px] text-emerald-400">2 Spots Left</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-sm bg-[#161B14] border border-stone-800">
              <span className="text-[10px] text-[#C4A482] uppercase tracking-wider font-bold">SANCTUARY 03</span>
              <h3 className="font-serif text-lg font-bold text-white mt-1 mb-2">Cold Immersion & Surf (Nosara)</h3>
              <p className="text-stone-400 text-[11px] mb-4">January 15 – 21, 2027 · 7-Day Alignment</p>
              <div className="space-y-3">
                <div className="p-3 bg-black/50 rounded border border-stone-800 flex justify-between">
                  <div>
                    <div className="text-white font-bold">Ocean Ridge Bungalow</div>
                    <div className="text-[10px] text-stone-500">Direct beach access & ice plunge</div>
                  </div>
                  <div className="text-right">
                    <div className="text-[#C4A482] font-bold">$4,200</div>
                    <div className="text-[10px] text-emerald-400">4 Spots Left</div>
                  </div>
                </div>
                <div className="p-3 bg-black/50 rounded border border-stone-800 flex justify-between">
                  <div>
                    <div className="text-white font-bold">Garden Pavilion Room</div>
                    <div className="text-[10px] text-stone-500">Shared pool & courtyard</div>
                  </div>
                  <div className="text-right">
